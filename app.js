/* ========================================================
   ...
   const statesData = [
    ...
    { code: "MS", name: "Mississippi", visited: true, date: "Visited", icon: "🚔", memory: "A wild midnight drive accidentally following a high-speed chase, plus food that tasted like dish soap!" },
    ...
    { code: "NM", name: "New Mexico", visited: true, date: "Visited", icon: "👽", memory: "Hunted for aliens in Roswell and explored the mind-bending art of Meow Wolf!" },
    ...
    { code: "TX", name: "Texas", visited: true, date: "Visited", icon: "🌮", memory: "Why was Van Horn so much fun?!?, Houston was a heart attack trying to drive through but the breakfast tacos were fire!" },
